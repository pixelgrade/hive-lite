...
if ( ! function_exists( 'hive_get_post_format_first_image' ) ) :

	function hive_get_post_format_first_image() {
		global $post;
...
if ( ! function_exists( 'hive_get_post_format_link_url' ) ) :
	/**
	 ...
	 * @return string URL
	 */
	function hive_get_post_format_link_url() {
		$content = get_the_content();
