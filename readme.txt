...
Tested up to: 5.2.2
Tags: one-column, two-columns, three-columns, grid-layout, right-sidebar, editor-style, featured-images, rtl-language-support, sticky-post, translation-ready, blog, news, custom-menu, threaded-comments, post-formats, custom-logo
...
* Added style.css tags for the features the theme supports.
